...
test_cfg = dict(
    ...
    rcnn=dict(
        ...
        score_thr = 0.05, nms = dict(type='py_cpu_nms_poly_fast', iou_thr=0.1), max_per_img = 3000)
...
data = dict(
    ...
    train=dict(
        ...
        img_prefix=imgae_root + 'trainval1024/images/',
        img_scale=(1024, 1024),
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_RoITrans_r50_fpn_1x_dota1_5_car'
load_from = '/content/gdrive/My Drive/Arirang/epoch_12.pth'
resume_from = None
workflow = [('train', 1)]
